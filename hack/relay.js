...
async function main() {
  ...
  console.log(`====== Examining hub balances ======`);
  ...
  console.log(`====== Examining ETH balances ======`);
  const initial_recipient_eth_balance = await web3.eth.getBalance(metaCoin.address);
  console.log(`Recipient eth balance: ${initial_recipient_eth_balance}`);
  const initial_relay_owner_eth_balance = await web3.eth.getBalance(accounts.relay_owner);
  console.log(`Relay owner eth balance: ${initial_relay_owner_eth_balance}`);
